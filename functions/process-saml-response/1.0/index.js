...
const processSamlResponse = async ({ request }) => {
	...
	fetch('https://test-joeri.bettywebblocks.com/testpage', {
		method: 'POST',
	...
	const jobtitle = fetchAttribute(
		converted.Response.Assertion.AttributeStatement,
		'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/jobtitle/JobTitle'
	);

	const office = fetchAttribute(
		converted.Response.Assertion.AttributeStatement,
		'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/office/Office'
	);

	const department = fetchAttribute(
		converted.Response.Assertion.AttributeStatement,
		'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/department/Department'
	);

	const positiongroup = fetchAttribute(
		converted.Response.Assertion.AttributeStatement,
		'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/positiongroup/PositionGroup'
	);
